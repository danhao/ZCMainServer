...
public class TestClient {
	...
	public static void main(String[] args) {
		try {
			...
			String createDebt = "{'code':100,'pid':606342446812499968,'sid':'8c9e6ff5-dd09-4883-9499-40ad14d353c5','req':{updateId:'636787530687057920',type:2,'money':1018,'creditorName':'haha',expireDays:5,'contacts':{'name':'11','phone':'test'}}}";
